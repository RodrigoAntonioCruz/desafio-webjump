...
class Products extends Controller
{
    ...
    {
        $pageContent = file_get_contents('../resources/views/product/products.html');
    ...
    public function new()
    {
        $pageContent = file_get_contents('../resources/views/product/addProduct.html');
    ...
    public function edit(string $sku)
    {
        ...
        $pageContent = file_get_contents('../resources/views/product/editProduct.html');
