...
class Categories extends Controller
{
    ...
    {
        $pageContent = file_get_contents('../resources/views/category/categories.html');
    ...
    public function new()
    {
        $pageContent = file_get_contents('../resources/views/category/addCategory.html');
    ...
    public function edit(string $codigo)
    {
        ...
        $pageContent = file_get_contents('../resources/views/category/editCategory.html');
